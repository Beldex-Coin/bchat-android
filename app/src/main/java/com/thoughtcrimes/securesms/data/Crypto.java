...
public enum Crypto {
    XMR("XMR", true, "Beldex:tx_amount:recipient_name:tx_description", R.id.ibBDX, R.drawable.ic_bchat_logo, R.drawable.ic_bchat_logo, Wallet::isAddressValid),
    BTC("BTC", true, "bitcoin:amount:label:message", R.id.ibBDX, R.drawable.ic_bchat_logo, R.drawable.ic_bchat_logo, address -> {
        Timber.d("BTC ->%s", address);
        return BitcoinAddressValidator.validate(address, BitcoinAddressType.BTC);
    }),
    DASH("DASH", true, "dash:amount:label:message", R.id.ibBDX, R.drawable.ic_bchat_logo, R.drawable.ic_bchat_logo, address -> {
        return BitcoinAddressValidator.validate(address, BitcoinAddressType.DASH);
    }),
    DOGE("DOGE", true, "dogecoin:amount:label:message", R.id.ibBDX, R.drawable.ic_bchat_logo, R.drawable.ic_bchat_logo, address -> {
        return BitcoinAddressValidator.validate(address, BitcoinAddressType.DOGE);
    }),
    //ETH("ETH", false, "ethereum:amount:label:message", R.id.ibBDX, R.drawable.ic_bchat_logo, R.drawable.ic_bchat_logo, EthAddressValidator::validate),
    LTC("LTC", true, "litecoin:amount:label:message", R.id.ibBDX, R.drawable.ic_bchat_logo, R.drawable.ic_bchat_logo, address -> {
