...
public class PointerAttachment extends Attachment {
  ...
  /**
   * Converts a Bchat Attachment to a Signal Attachment
   * @param attachment Bchat Attachment
   * @return Signal Attachment
   */
  public static Attachment forAttachment(com.beldex.libbchat.messaging.messages.visible.Attachment attachment) {
    return new PointerAttachment(attachment.getContentType(),
            ...
            null,
            attachment.getKind() == com.beldex.libbchat.messaging.messages.visible.Attachment.Kind.VOICE_MESSAGE,
