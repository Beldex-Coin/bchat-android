...
/**
 * Allows to handle the {@link com.thoughtcrimes.securesms.wallet.utils.pincodeview.managers.AppLock} from within
...
public class LockManager<T extends AppLockActivity> {
    ...
    /**
     * The static singleton instance of {@link com.thoughtcrimes.securesms.wallet.utils.pincodeview.managers.AppLock}
     */
    ...
    /**
     * Tells the app if the {@link com.thoughtcrimes.securesms.wallet.utils.pincodeview.managers.AppLock} is enabled or not
     */
