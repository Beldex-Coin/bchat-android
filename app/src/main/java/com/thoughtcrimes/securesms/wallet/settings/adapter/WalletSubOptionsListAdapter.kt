package com.thoughtcrimes.securesms.wallet.settings.adapter
...
class WalletSubOptionsListAdapter internal constructor(context: Context?, data: List<String>,indexPosition:Int,option:Int) :
    RecyclerView.Adapter<WalletSubOptionsListAdapter.ViewHolder>() {
    ...
    inner class ViewHolder internal constructor(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        override fun onClick(view: View?) {
            if (mClickListener != null) {
                mClickListener!!.onItemClick(view, adapterPosition,option)
    ...
    interface ItemClickListener {
        fun onItemClick(view: View?, position: Int,option:Int)
    }
