package com.thoughtcrimes.securesms.lottie;
...
public class LottieDialog {
    ...
    /**
     * View to control the close icon of lottie dialog
     */
    private final ImageView lottieDialogCloseIcon;
    ...
    public LottieDialog(Context context) {
        ...
        this.lottieDialogCloseIcon = view.findViewById(R.id.lottie_dialog_exit_icon);
        this.lottieDialogCloseIcon.setOnClickListener(new View.OnClickListener(){
