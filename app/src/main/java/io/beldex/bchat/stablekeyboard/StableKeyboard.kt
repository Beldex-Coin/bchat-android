package io.beldex.bchat.stablekeyboard
...
class StableKeyboard(context: Context?, attrs: AttributeSet?, defStyleAttr: Int) :
    ...
    private fun init(context: Context?, attrs: AttributeSet?) {
        LayoutInflater.from(context).inflate(R.layout.activity_stable_keyboard, this, true)
        ...
        keyValues.put(R.id.button_enter, "NEXT")
    }
