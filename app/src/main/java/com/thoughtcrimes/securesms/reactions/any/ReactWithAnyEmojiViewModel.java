...
import com.thoughtcrimes.securesms.components.emoji.EmojiPageViewGridAdapter;
import com.thoughtcrimes.securesms.database.model.MessageId;
import com.thoughtcrimes.securesms.keyboard.emoji.search.EmojiSearchRepository;

import com.thoughtcrimes.securesms.reactions.ReactionsRepository;
import com.thoughtcrimes.securesms.util.adapter.mapping.MappingModelList;
...
public final class ReactWithAnyEmojiViewModel extends ViewModel {
  ...
  static class Factory implements ViewModelProvider.Factory {
    ...
    public @NonNull <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
      ...
      return modelClass.cast(new ReactWithAnyEmojiViewModel(repository, messageId, isMms, new EmojiSearchRepository(MessagingModuleConfiguration.shared.getContext())));
    }
  }
