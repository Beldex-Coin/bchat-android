...
import com.thoughtcrimes.securesms.conversation.v2.ViewUtil;
import com.thoughtcrimes.securesms.util.ContextUtil;
import com.thoughtcrimes.securesms.util.DrawableUtil;
import com.thoughtcrimes.securesms.util.adapter.mapping.MappingModel;


import org.thoughtcrime.securesms.components.emoji.EmojiItemDecoration;
...
public class EmojiPageView extends RecyclerView implements EmojiPageViewGridAdapter.VariationSelectorListener {
  ...
  private OnItemTouchListener scrollDisabler;
      ...
      gridLayout.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
        ...
        public int getSpanSize(int position) {
          if (getAdapter() != null) {
            ...
            if (model.isPresent() && (model.get() instanceof EmojiPageViewGridAdapter.EmojiHeader || model.get() instanceof EmojiPageViewGridAdapter.EmojiNoResultsModel)) {
  ...
  private static class ScrollDisabler implements OnItemTouchListener {
    @Override
