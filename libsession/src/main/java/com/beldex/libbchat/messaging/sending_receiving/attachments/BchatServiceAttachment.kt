...
abstract class BchatServiceAttachment protected constructor(val contentType: String?) {
    ...
    fun asStream(): BchatServiceAttachmentStream {
        return this as BchatServiceAttachmentStream
    }

    fun asPointer(): BchatServiceAttachmentPointer {
        return this as BchatServiceAttachmentPointer
    }
    ...
    class Builder internal constructor() {
        ...
        fun build(): BchatServiceAttachmentStream {
            ...
            return BchatServiceAttachmentStream(inputStream, contentType, length, Optional.fromNullable(fileName), voiceNote, Optional.absent(), width, height, Optional.fromNullable(caption), listener)
        }
    }
