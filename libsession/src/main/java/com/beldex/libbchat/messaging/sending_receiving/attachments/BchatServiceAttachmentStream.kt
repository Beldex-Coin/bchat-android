...
import com.beldex.libsignal.messages.SignalServiceAttachment as SAttachment
 ...
 */
class BchatServiceAttachmentStream(val inputStream: InputStream?, contentType: String?, val length: Long, val fileName: Optional<String?>?, val voiceNote: Boolean, val preview: Optional<ByteArray?>, val width: Int, val height: Int, val caption: Optional<String?>, val listener: SAttachment.ProgressListener?) : BchatServiceAttachment(contentType) {
