package com.thoughtcrimes.securesms.linkpreview;
...
import com.thoughtcrimes.securesms.net.CallRequestController;
import com.thoughtcrimes.securesms.net.CompositeRequestController;
import com.thoughtcrimes.securesms.net.ContentProxySafetyInterceptor;
import com.thoughtcrimes.securesms.net.RequestController;
...
import com.thoughtcrimes.securesms.linkpreview.LinkPreviewUtil.OpenGraph;
...
public class LinkPreviewRepository {
                                                         ...
                                                         @NonNull String contentType)
  {
    ...
    Uri    uri   = BlobProvider.getInstance().forData(bytes).createForSingleBchatInMemory();
