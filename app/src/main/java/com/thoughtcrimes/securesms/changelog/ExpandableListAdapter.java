...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        ImageView lblListImageView = (ImageView) convertView.findViewById(R.id.lblListImage);
        lblListHeader.setTypeface(null, Typeface.BOLD);
        lblListHeader.setText(headerTitle);
        if (isExpanded) {
            lblListImageView.setImageResource(R.drawable.ic_baseline_keyboard_arrow_up_24);
        } else {
            lblListImageView.setImageResource(R.drawable.ic_baseline_keyboard_arrow_down_24);
        }
        return convertView;
    }
