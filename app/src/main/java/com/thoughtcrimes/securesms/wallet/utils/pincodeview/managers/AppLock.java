...
public abstract class AppLock {
    ...
    /**
     * EXTRA_TYPE, uses to pass to the {@link com.thoughtcrimes.securesms.wallet.utils.pincodeview.managers.AppLockActivity}
     ...
     * take into account for the {@link com.thoughtcrimes.securesms.wallet.utils.pincodeview.PinActivity}. These activities
     * will not log the last opened time, will not launch the
     * {@link com.thoughtcrimes.securesms.wallet.utils.pincodeview.managers.AppLockActivity} etc...
     */
    ...
    /**
     * Get logo resource id used by {@link com.thoughtcrimes.securesms.wallet.utils.pincodeview.managers.AppLockActivity}
     */
    public abstract int getLogoId();

    /**
     * Set logo resource id used by {@link com.thoughtcrimes.securesms.wallet.utils.pincodeview.managers.AppLockActivity}
     */
    public abstract void setLogoId(int logoId);

    /**
     * Get the forgot option used by {@link com.thoughtcrimes.securesms.wallet.utils.pincodeview.managers.AppLockActivity}
     */
    public abstract boolean shouldShowForgot();

    /**
     * Set the forgot option used by {@link com.thoughtcrimes.securesms.wallet.utils.pincodeview.managers.AppLockActivity}
     */
    ...
    /**
     * Enable the {@link com.thoughtcrimes.securesms.wallet.utils.pincodeview.managers.AppLock} by setting
     * {@link com.thoughtcrimes.securesms.wallet.utils.pincodeview.managers.AppLockImpl} as the
     * {@link com.thoughtcrimes.securesms.wallet.utils.keyboardview.interfaces.LifeCycleInterface}
     */
    public abstract void enable();

    /**
     * Disable the {@link com.thoughtcrimes.securesms.wallet.utils.pincodeview.managers.AppLock} by removing any
     * {@link com.thoughtcrimes.securesms.wallet.utils.keyboardview.interfaces.LifeCycleInterface}
     */
    ...
    /**
     * Disable the {@link com.thoughtcrimes.securesms.wallet.utils.pincodeview.managers.AppLock} by removing any
     * {@link com.thoughtcrimes.securesms.wallet.utils.keyboardview.interfaces.LifeCycleInterface} and also delete
     ...
     * Set in {@link com.thoughtcrimes.securesms.wallet.utils.keyboardview.interfaces.LifeCycleInterface#onActivityPaused(android.app.Activity)}
     * and {@link com.thoughtcrimes.securesms.wallet.utils.keyboardview.interfaces.LifeCycleInterface#onActivityResumed(android.app.Activity)}
     */
    ...
    /**
     * Evaluates if:
     * - we are already into the {@link com.thoughtcrimes.securesms.wallet.utils.pincodeview.managers.AppLockActivity}
     * - the passcode is not set
     * - the timeout didn't reached
     * If any of this is true, then we don't need to start the
     * {@link com.thoughtcrimes.securesms.wallet.utils.pincodeview.managers.AppLockActivity} (it returns false)
